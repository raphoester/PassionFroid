                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div>
                            ...
                            <label for="institutionelle-non">Non</label>
                            <input type="radio" id="institutionelle-non" name="institutionnelle" value="false"
                                checked><br>';
                            }
                            @endphp
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" id="datefindroits" name="dateFinDroits"
                                value="{{$image->dateFinDroits}}"><br><br>
                        </div>
                        <div>
